              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                ...
                <tbody>
                  {beasiswaList.map((b, idx) => {
                    ...
                    const isSubmitting = submittingId === b.beasiswaId;
                    return (
                      <tr
                        key={b.beasiswaId}
                        style={{
                      ...
                      >
                        ...
                        <td style={{ ...tdStyle, maxWidth: 280 }}>
                          ...
                          {b.alasanPenolakan && b.status === 'draft' && (
                            <div style={{
                              marginTop: 6, padding: '6px 8px', fontSize: 11,
                              background: '#fef2f2', border: '1px solid #fecaca',
                              borderRadius: 6, color: C.red,
                            }}>
                              <strong>Ditolak Admin:</strong> {b.alasanPenolakan}
                            </div>
                          )}
                        </td>
                        ...
                        <td style={{ ...tdStyle, textAlign: 'center' }}>
                          <div style={{ display: 'flex', gap: 6, justifyContent: 'center', flexWrap: 'wrap' }}>
                            ...
                            {b.status === 'draft' && (
                              <button
                                onClick={() => handleSubmitApproval(b)}
                                disabled={isSubmitting}
                                title="Ajukan ke admin"
                                style={{
                                  padding: '6px 10px',
                                  background: isSubmitting ? '#d1d5db' : '#ff9800',
                                  color: C.white,
