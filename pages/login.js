        ...
        >
          <div className="w-full max-w-md">
            ...
            <form onSubmit={handleLogin} noValidate>
                ...
                {ROLES.map((r) => {
                  ...
                  return (
                    <button
                      key={r.value}
                      type="button"
                      onClick={() => { setSelectedRole(r.value); setError(''); setNotice(''); }}
              ...
              {/* ── Pending Verification Notice (di bawah tombol Masuk) ─── */}
              {notice && (
                <div
                  className="flex items-start gap-2.5 px-4 py-3 rounded-lg mt-4 text-sm"
